...
public class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<DomnumDbContext>
{
    public DomnumDbContext CreateDbContext(string[] args)
    {
       try
        {
        ...
        Console.WriteLine($"[DEBUG] Connection string: {connectionString}");
            ...
            var builder = new DbContextOptionsBuilder<DomnumDbContext>();
            builder.UseNpgsql(connectionString);
            var context = new DomnumDbContext(builder.Options);
            return context;
        }
        catch (Exception ex)
        {
